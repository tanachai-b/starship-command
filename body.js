...
class Camera {
    ...
    //     let zoom = 2 ** (this.zoom / 4);

    //     let nx = (x - this.x) / zoom;
    //     let ny = (y - this.y) / zoom;

    //     let nnx = nx * Math.cos(this.r) - ny * Math.sin(this.r) + ctx.canvas.width / 2;
    //     let nny = ny * Math.cos(this.r) + nx * Math.sin(this.r) + ctx.canvas.height / 2;
